...
const Angular: React.FC = () => {
    ...
    const [projectName, setProjectName] = useState<string>('my-angular-app');

    const fetchStructure = async () => {
        fetchStructureProject('http://localhost:3003/angular-app/fetch-structure', {
            appName: projectName,
        }, setStructure)
    };

    const handleSaveStructure = async () => {
        handleSaveStructureProject('http://localhost:3003/angular-app/create', {
            structure: structure,
