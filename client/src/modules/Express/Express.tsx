...
const Express: React.FC = () => {
    ...
    const fetchStructure = async () => {
        setLoading(true);
        await fetchStructureProject('http://localhost:3003/express-app/fetch-cached-structure', setStructure);
        setLoading(false);
    };
    ...
    return (
        <div className="min-h-screen bg-[#1e1e1e]">
            ...
            {loading ?
                <div className="flex justify-center items-center min-h-screen"><CustomLoader /></div>
                : <div className="pt-12 px-4 md:px-8 overflow-x-hidden">
                    <h1 className="text-white text-xl mb-4">Customize Your Project</h1>
                    {structure ? (
                        <>
                            <FolderStructure
                                structure={structure}
