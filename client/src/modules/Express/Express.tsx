...
const Express: React.FC = () => {
    ...
    const [projectName, setProjectName] = useState<string>('my-express-app');

    const fetchStructure = async () => {
        fetchStructureProject('http://localhost:3003/express-app/fetch-structure', {
            appName: projectName,
        }, setStructure)
    };

    const handleSaveStructure = async () => {
        handleSaveStructureProject('http://localhost:3003/express-app/create', {
            structure: structure,
