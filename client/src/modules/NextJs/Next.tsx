...
import { addNpmPackage, handleAddDirectory, handleDeleteDirectory, handleDeletePackage, searchNpmPackages, handleSaveStructureProject, fetchStructureProjectNext } from '../../utlis/common/common.utils';
...
const Next: React.FC = () => {
    ...
    const [language, setLanguage] = useState<string>('ts'); // Default to TypeScript
